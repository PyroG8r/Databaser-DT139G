...
CREATE TABLE OFFER  (
   ...
   RESTAURANT_ID        VARCHAR(30)           NOT NULL,
   PRIMARY KEY (DESSERT_CODE, DESSERT_OFFERED_DATE_RANGE, RESTAURANT_ID)
);
...
/*
--- MariaDB(MYSQL) doesnt name primary key constraints. 
--To avoid these warnings we comment out these rows
